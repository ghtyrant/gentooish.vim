...
if has('gui_running')
    ...
    hi TabLineFill    gui=UNDERLINE   guifg=#cccccc   guibg=#191919
    hi TabLine        gui=UNDERLINE   guifg=#cccccc   guibg=NONE
    hi TabLineSel     gui=UNDERLINE,BOLD   guifg=#8bff95   guibg=#222222
